...
def scrape_weather():
    print("[오늘의 날씨]")
    url = "https://search.naver.com/search.naver?sm=tab_hty.top&where=nexearch&query=%EC%84%9C%EC%9A%B8+%EB%82%A0%EC%94%A8&oquery=%EC%84%9C%EC%9A%B8+%EB%82%A0%EC%94%A8&tqi=UHjA1wp0J1Zssdsvk3lssssss0Z-512480"
...
def scrape_headline_news():
    ...
    for index, news in enumerate(news_list):
        title = news.find("a").get_text().strip() # 제목
        link = url + news.find("a")["href"] # 링크
...
def scrape_english():
    ...
    # (영어 지문)
    # Jason : How do you think blah blah..?
    # Kim : Well, I think..
    print("(영어 지문)")
